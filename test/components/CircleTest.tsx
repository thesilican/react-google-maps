...
import { Circle, Map } from "../../src";

const weightedMap = [
  { lat: 37.782, lng: -122.447, radius: 1 },
  { lat: 37.782, lng: -122.443, radius: 2 },
  { lat: 37.782, lng: -122.441, radius: 3 },
  { lat: 37.782, lng: -122.439, radius: 4 },
  { lat: 37.782, lng: -122.435, radius: 5 },
  { lat: 37.785, lng: -122.447, radius: 6 },
  { lat: 37.785, lng: -122.445, radius: 7 },
  { lat: 37.785, lng: -122.441, radius: 8 },
  { lat: 37.785, lng: -122.437, radius: 9 },
  { lat: 37.785, lng: -122.435, radius: 10 },
  { lat: 37.785, lng: -122.4, radius: 11 },
];
  ...
  return (
    <div className="map">
      <Map center={center} zoom={14}>
        {locations.map((x, i) => (
          <Circle key={i} center={x} radius={x.radius} />
        ))}
        {points.map((x, i) => (
          <Circle
            key={i}
